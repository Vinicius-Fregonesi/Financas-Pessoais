...
namespace LightNap.DataProviders.SqlServer.Migrations
{
    ...
    [Migration("20250722202835_ColocandoAnexosEmFinancas")]
    partial class ColocandoAnexosEmFinancas
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LightNap.Core.Data.Entities.AnexoFinanceiro", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FinancasId");

                    b.ToTable("AnexosFinanceiros");
                });
            ...
            modelBuilder.Entity("LightNap.Core.Data.Entities.AnexoFinanceiro", b =>
                {
                    b.HasOne("LightNap.Core.Data.Entities.Financas", "Financa")
                        .WithMany("Anexos")
                        .HasForeignKey("FinancasId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Financa");
                });
